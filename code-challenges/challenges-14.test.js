...
const screenForNames = arr => arr.filter(name => (/^(Mr.|Mrs.|Ms.|Dr.)\s[A-Za-z]+/).test(name));
...
const toTitleCase = arr => arr.map(string => string[0].toUpperCase() + string.slice(1));
